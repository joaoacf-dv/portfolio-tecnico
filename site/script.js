...
const ptToEn = {
  ...
  "Base técnica de monitoramento, dashboards e alertas apresentada.": "Technical monitoring foundation with dashboards and alerts presented in a public-facing format.",
  "O case consolida uma trilha de observabilidade com coleta, visualização e notificação.": "This case consolidates an observability workflow with monitoring, visualization and notification layers, preserving the reusable technical structure of the solution.",
  "O desafio era organizar monitoramento de hosts, criação de dashboards e regras de alerta em uma base coesa, capaz de apoiar operação técnica.": "The challenge was to organize host monitoring, dashboard creation and alert rules into a cohesive foundation capable of supporting technical operations.",
  "A solução combina Zabbix como plataforma de monitoramento, Grafana como camada de visualização e integrações auxiliares para notificação.": "The solution combines Zabbix as the monitoring platform, Grafana as the visualization layer and auxiliary integrations for notifications.",
  "O material evidencia resultados concretos em observabilidade, com implementação de coleta, visualização, monitoramento e alertas, demonstrando domínio técnico aplicado": "The case presents concrete results in observability, with collection, visualization, monitoring and alerts implemented to demonstrate applied technical capability.",
  "A solução combina launcher em Python com interface Tkinter, scripts PowerShell organizados por categoria, recursos auxiliares e fluxo de empacotamento para distribuição controlada.": "The solution combines a Python launcher with a Tkinter interface, PowerShell scripts organized by category, supporting resources and a controlled packaging workflow for distribution.",
  "O case apresenta uma arquitetura de atendimento capaz de concentrar conversas, organizar regras de triagem e sustentar automação em um fluxo omnichannel.": "This case presents a support architecture capable of centralizing conversations, organizing triage rules and supporting automation within an omnichannel workflow.",
  "A solução combina Chatwoot como núcleo operacional, canais externos de mensageria, camada de eventos, categorização de mensagens e um serviço auxiliar em Flask para decisões automatizadas.": "The solution combines Chatwoot as the operational core, external messaging channels, an event layer, message categorization and an auxiliary Flask service for automated decisions.",
  "O material demonstra entendimento consistente de integração omnichannel e automação de resposta.": "The case demonstrates consistent understanding of omnichannel integration and response automation, preserving publication safety without losing technical clarity.",
  "Tela de login do Chatwoot representando o acesso administrativo à plataforma de atendimento omnichannel": "Chatwoot login screen representing administrative access to the omnichannel support platform",
  "Tela de autenticação da plataforma Chatwoot, representando o acesso administrativo ao ambiente de atendimento omnichannel.": "Chatwoot platform authentication screen representing administrative access to the omnichannel support environment.",
  "Tela de caixa de entrada do Chatwoot com notificações centralizadas de múltiplos canais de atendimento": "Chatwoot inbox screen with centralized notifications from multiple support channels",
  "Caixa de entrada centralizada para acompanhamento de notificações e interações recebidas pelos canais integrados da operação omnichannel.": "Centralized inbox for tracking notifications and interactions received through integrated omnichannel operations channels.",
  "Tela de conversas do Chatwoot com atendimentos vindos de canais como Instagram, Facebook, Gmail e Telegram": "Chatwoot conversations screen with support interactions from channels such as Instagram, Facebook, Gmail and Telegram",
  "Painel de conversas omnichannel reunindo atendimentos de diferentes canais em uma única interface de operação.": "Omnichannel conversations panel bringing support interactions from different channels into a single operational interface.",
  "Configuração de caixas de entrada do Chatwoot com canais Facebook Messenger, Gmail, Instagram e Telegram": "Chatwoot inbox configuration with Facebook Messenger, Gmail, Instagram and Telegram channels",
  "Configuração das caixas de entrada integradas ao Chatwoot, contemplando canais como Facebook Messenger, Gmail, Instagram e Telegram.": "Configuration of inboxes integrated with Chatwoot, covering channels such as Facebook Messenger, Gmail, Instagram and Telegram.",
  "Tela de configuração de agentes no Chatwoot com perfis de atendimento e permissões administrativas": "Chatwoot agent configuration screen with support profiles and administrative permissions",
  "Gerenciamento de agentes da plataforma, com definição de perfis, permissões e participantes responsáveis pelo atendimento ao cliente.": "Platform agent management with profiles, permissions and participants responsible for customer support.",
  "Tela de configuração de times no Chatwoot para organização de agentes por grupos de atendimento": "Chatwoot team configuration screen for organizing agents by support groups",
  "Organização dos agentes em times operacionais, permitindo distribuição de conversas por área, função ou responsabilidade de atendimento.": "Organization of agents into operational teams, enabling conversation distribution by area, role or support responsibility.",
  "Tela de contatos do Chatwoot com registros de clientes e empresas atendidas pela plataforma": "Chatwoot contacts screen with records of customers and companies supported through the platform",
  "Base de contatos integrada ao atendimento, funcionando como apoio operacional para histórico, identificação e relacionamento com clientes.": "Contact base integrated with support operations, providing operational support for history, identification and customer relationships.",
  "Tela de automação do Chatwoot com regras ativas para comandos, atendimento virtual, dúvidas, horário de funcionamento e integração com Telegram": "Chatwoot automation screen with active rules for commands, virtual support, questions, business hours and Telegram integration",
  "Regras de automação configuradas para padronizar fluxos de atendimento, acionar comandos, responder dúvidas e apoiar o assistente virtual.": "Automation rules configured to standardize support flows, trigger commands, answer questions and support the virtual assistant.",
  "Tela de respostas prontas do Chatwoot com modelos de mensagens para apresentação, finalização e primeiro contato": "Chatwoot canned responses screen with message templates for introductions, closing and first contact",
  "Respostas prontas estruturadas para acelerar o atendimento, padronizar comunicações e apoiar agentes durante conversas recorrentes.": "Structured canned responses to speed up support, standardize communications and assist agents during recurring conversations.",
  "Relatório de conversas do Chatwoot com métricas de conversas, mensagens recebidas, mensagens enviadas e tempo de primeira resposta": "Chatwoot conversations report with metrics for conversations, received messages, sent messages and first response time",
  "Relatório de conversas com métricas de volume, mensagens recebidas, mensagens enviadas e tempo médio de primeira resposta.": "Conversation report with volume metrics, received messages, sent messages and average first response time.",
  "Relatório de agentes do Chatwoot com métricas de conversas, primeira resposta, resolução e contagem de casos resolvidos": "Chatwoot agents report with metrics for conversations, first response, resolution and resolved case count",
  "Visão geral de agentes com indicadores de desempenho, tempo de resposta, tempo de resolução e quantidade de casos resolvidos.": "Agent overview with performance indicators, response time, resolution time and resolved case count.",
  "Relatório de etiquetas do Chatwoot com métricas de conversas classificadas por negócios e vendas": "Chatwoot labels report with metrics for conversations classified by business and sales",
  "Relatório por etiquetas para acompanhar categorias de atendimento, classificar demandas e medir desempenho por tipo de conversa.": "Label report for tracking support categories, classifying requests and measuring performance by conversation type.",
  "Relatório de caixas de entrada do Chatwoot comparando canais como Facebook, Instagram, Telegram e Gmail": "Chatwoot inbox report comparing channels such as Facebook, Instagram, Telegram and Gmail",
  "Comparativo de desempenho por caixa de entrada, permitindo avaliar volume, resposta e resolução entre os canais integrados.": "Performance comparison by inbox, enabling evaluation of volume, response and resolution across integrated channels.",
  "Resumo de time no Chatwoot com métricas de conversas, tempo médio de primeira resposta, resolução e contagem de casos resolvidos": "Chatwoot team summary with metrics for conversations, average first response time, resolution and resolved case count",
  "Resumo de desempenho por time, oferecendo visão gerencial sobre volume de conversas, tempo de resposta e resolução dos atendimentos.": "Team performance summary providing a management view of conversation volume, response time and support resolution.",
  "Relatório CSAT do Chatwoot com pontuação de satisfação, taxa de resposta e feedbacks de clientes": "Chatwoot CSAT report with satisfaction score, response rate and customer feedback",
  "Relatório CSAT para análise de satisfação dos clientes, taxa de resposta, classificações recebidas e comentários de feedback.": "CSAT report for analyzing customer satisfaction, response rate, received ratings and feedback comments.",
  "Painel de visão geral do Chatwoot com indicadores de conversas abertas, atendimentos não atribuídos, status dos agentes e tráfego de conversas": "Chatwoot overview dashboard with indicators for open conversations, unassigned support interactions, agent status and conversation traffic",
  "Visão geral operacional do Chatwoot, consolidando conversas abertas, atendimentos pendentes, status dos agentes e tráfego de atendimento em tempo real.": "Chatwoot operational overview consolidating open conversations, pending support interactions, agent status and real-time support traffic.",
  "UI responsiva": "Responsive UI",
  "Este case apresenta uma frente de capacidade em desenvolvimento web e presença digital, com foco na estruturação de interfaces, organização visual de conteúdo, responsividade, navegação e publicação web.": "This case presents a web development and digital presence capability track focused on structuring public-facing interfaces, organizing visual content, responsiveness, navigation and web publishing.",
  "O desafio consiste em estruturar uma base de apresentação web que seja clara, responsiva, publicável e preparada para evolução.": "The challenge is to structure a public web presentation base that is clear, responsive, publishable and prepared for evolution.",
  "A frente exige atenção a hierarquia visual, semântica, navegação, responsividade, consistência de conteúdo.": "The track requires attention to visual hierarchy, semantics, navigation, responsiveness and content consistency.",
  "Estruturação de páginas e navegação.": "Page and navigation structure.",
  "A frente consolida uma base profissional de desenvolvimento web aplicada à criação de interfaces, organização visual, responsividade, publicação e evolução incremental.": "This track consolidates a professional web development foundation applied to public interfaces, visual organization, responsiveness, publishing and incremental evolution.",
  // PORTFOLIO_PRAGMA_NORYO_SHOWCASE_20260911
  "Produto SaaS · Automação, IA e Integração": "SaaS Product · Automation, AI and Integration",
  "PRAGMA — Automation & AI Platform": "PRAGMA — Automation & AI Platform",
  "Plataforma de automação e IA para estruturar atendimento, canais, assistentes, modelos, formulários, operações e controle comercial em uma única camada operacional.": "Automation and AI platform that structures support, channels, assistants, templates, forms, operations and commercial control in a single operational layer.",
  "Produto Web · Utility Portal": "Web Product · Utility Portal",
  "Noryo — Utility Portal": "Noryo — Utility Portal",
  "Portal público de utilitários web com arquitetura estática, rotas bilíngues e processamento local no navegador para operações compatíveis.": "Public web-utility portal with a static architecture, bilingual routes and local browser processing for compatible operations.",
  "Área: Automação, IA e Integração": "Area: Automation, AI and Integration",
  "Produto SaaS": "SaaS Product",
  "Área: Desenvolvimento Web e Produto Digital": "Area: Web Development and Digital Product",
  "Produto Web": "Web Product",
  "Plataforma de automação e IA concebida como uma camada operacional para centralizar atendimento, automações, inteligência assistida, modelos reutilizáveis e gestão.": "Automation and AI platform designed as an operational layer for centralized support, automation, assisted intelligence, reusable templates and management.",
  "Produto em produção": "Production product",
  "O PRAGMA consolida uma arquitetura de atendimento e automação em torno do PRAGMA Manager, canais e assistentes, PRAGMA AI, biblioteca de modelos, Forms V1, gestão operacional e controle comercial.": "PRAGMA consolidates a support and automation architecture around PRAGMA Manager, channels and assistants, PRAGMA AI, a template library, Forms V1, operational management and commercial control.",
  "O desenho separa canal, atendimento, automação, inteligência e operação humana. A plataforma foi evoluída por baselines versionadas e gates técnicos, preservando revisão humana explícita nos fluxos sensíveis.": "The design separates channels, support, automation, intelligence and human operations. The platform evolved through versioned baselines and technical gates while preserving explicit human review in sensitive flows.",
  "Canal do cliente": "Customer channel",
  "Central de atendimento": "Support hub",
  "Automação e modelos": "Automation and templates",
  "Operação humana": "Human operation",
  "Gestão e controle": "Management and control",
  "PRAGMA Manager para administração da operação.": "PRAGMA Manager for operational administration.",
  "Canais e assistentes integrados ao fluxo de atendimento.": "Channels and assistants integrated into the support flow.",
  "Biblioteca pública e modelos pessoais reutilizáveis.": "Public library and reusable personal templates.",
  "Forms V1, catálogos, operações, pagamentos e controle comercial.": "Forms V1, catalogs, operations, payments and commercial control.",
  "PRAGMA AI Clone com comparação de conhecimento, revisão humana, merge ou rebase supervisionado e aplicação restrita à configuração de IA.": "PRAGMA AI Clone with knowledge comparison, human review, merge or supervised rebase, and application restricted to AI configuration.",
  "Integração entre serviços, APIs, webhooks e mensageria.": "Integration across services, APIs, webhooks and messaging.",
  "Arquitetura de aplicações e serviços em containers.": "Application and service architecture in containers.",
  "Modelagem de fluxos de automação com pontos explícitos de controle humano.": "Automation-flow modeling with explicit human-control points.",
  "Evolução controlada por documentação, versionamento, testes e gates de release.": "Controlled evolution through documentation, versioning, testing and release gates.",
  "O projeto demonstra capacidade de transformar uma stack de atendimento e mensageria em um produto operacional integrado, com automação, IA, governança e evolução versionada.": "The project demonstrates the ability to turn a support and messaging stack into an integrated operational product with automation, AI, governance and versioned evolution.",
  "Repositório público": "Public repository",
  "Baseline técnica": "Technical baseline",
  "Portal público de utilitários web orientado a tarefas rápidas, com execução estática, experiência bilíngue e processamento no navegador sempre que o fluxo permite.": "Public web-utility portal focused on quick tasks, with static delivery, a bilingual experience and browser-side processing whenever the workflow allows it.",
  "Em produção": "In production",
  "O Noryo é um produto web de utilidades organizado como portal público, com catálogo de ferramentas, rotas em português e inglês e arquitetura preparada para expansão incremental sem exigir backend para as operações client-side.": "Noryo is a web utility product organized as a public portal, with a tool catalog, Portuguese and English routes, and an architecture prepared for incremental expansion without requiring a backend for client-side operations.",
  "A aplicação utiliza Next.js e TypeScript com geração estática. Nos fluxos compatíveis, arquivos são processados diretamente no navegador, reduzindo dependência de infraestrutura de backend e mantendo o caminho de execução simples.": "The application uses Next.js and TypeScript with static generation. In compatible flows, files are processed directly in the browser, reducing backend infrastructure dependency and keeping the execution path simple.",
  "Entrada do usuário": "User input",
  "Interface web": "Web interface",
  "Processamento client-side": "Client-side processing",
  "Validação local": "Local validation",
  "Resultado": "Result",
  "Download ou uso imediato": "Download or immediate use",
  "Catálogo de utilitários com rotas públicas estáticas.": "Utility catalog with public static routes.",
  "Experiência bilíngue PT-BR e EN.": "Bilingual PT-BR and EN experience.",
  "PDF Core com juntar PDF, dividir PDF e JPG para PDF processados no cliente.": "PDF Core with merge PDF, split PDF and JPG-to-PDF processed on the client.",
  "Testes automatizados, lint, typecheck, build e smoke de navegador como gates de entrega.": "Automated tests, lint, typecheck, build and browser smoke tests as delivery gates.",
  "Arquitetura frontend com Next.js, React e TypeScript.": "Frontend architecture with Next.js, React and TypeScript.",
  "Processamento binário client-side e manipulação de PDF.": "Client-side binary processing and PDF manipulation.",
  "SEO técnico, rotas estáticas e internacionalização.": "Technical SEO, static routes and internationalization.",
  "Disciplina de release com regressão, evidência e rollback preservado.": "Release discipline with regression testing, evidence and preserved rollback.",
  "O projeto demonstra construção e operação de um produto web público enxuto, extensível e orientado a desempenho, com funcionalidades reais executadas diretamente no navegador.": "The project demonstrates the construction and operation of a lean, extensible, performance-oriented public web product with real functionality executed directly in the browser.",
  "Abrir Noryo": "Open Noryo"
};
